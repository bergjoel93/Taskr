...
/***/ "./src/create/createAddTaskForm.js":
/*!*****************************************!*\
  !*** ./src/create/createAddTaskForm.js ***!
  \*****************************************/
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../manage/ProjectManager */ "./src/manage/ProjectManager.js");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _createTask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createTask */ "./src/create/createTask.js");
...
function createTasks(tasks) {
  ...
  if (!tasks) {
    ...
    tasks.forEach(function (task) {
      var taskElement = (0,_createTask__WEBPACK_IMPORTED_MODULE_0__["default"])(task);
...
/***/ "./src/handle/handleAddTaskForm.js":
/*!*****************************************!*\
  !*** ./src/handle/handleAddTaskForm.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function handleAddTaskForm() {
  var projectId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
  ...
  cancelButton.addEventListener('click', function () {
    (0,_render_renderAddTaskForm__WEBPACK_IMPORTED_MODULE_0__.closeTaskForm)();
  });
  submitBtn.addEventListener('click', function (event) {
    ...
    if (taskId) {
      //updating an old task if there's a taskId. 
      _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_1__["default"].updateProjectTask(projectId, taskId, newTask);
    } else {
      // creating and adding a new task. 
      //Add task to project 
      _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_1__["default"].addTaskToProject(projectId, newTask);
    }

    // close the form
    (0,_render_renderAddTaskForm__WEBPACK_IMPORTED_MODULE_0__.closeTaskForm)();
    // re-render everything 
    var pageRenderer = new _render_renderPage__WEBPACK_IMPORTED_MODULE_2__["default"](projectId, filter);
  });
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (handleAddTaskForm);

/***/ }),

/***/ "./src/handle/handleNavbar.js":
/*!************************************!*\
  !*** ./src/handle/handleNavbar.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _render_renderTasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../render/renderTasks */ "./src/render/renderTasks.js");
/* harmony import */ var _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../manage/ProjectManager */ "./src/manage/ProjectManager.js");
/* harmony import */ var _render_renderAddTaskForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../render/renderAddTaskForm */ "./src/render/renderAddTaskForm.js");
/* harmony import */ var _render_renderPage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../render/renderPage */ "./src/render/renderPage.js");
/* harmony import */ var _render_renderNavbar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../render/renderNavbar */ "./src/render/renderNavbar.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
 ...
 */
var HandleNavbar = /*#__PURE__*/function () {
  function HandleNavbar() {
    _classCallCheck(this, HandleNavbar);
  ...
  return _createClass(HandleNavbar, [{
    ...
    value: function setupEventListeners() {
      ...
      addTaskBtn.addEventListener('click', function () {
        _this.makeActive(addTaskBtn);
        console.log('Add Task Button Clicked');
        (0,_render_renderAddTaskForm__WEBPACK_IMPORTED_MODULE_2__.renderNewAddTaskForm)();

        // TODO 
      });

      // All Tasks Button
      var allTasksBtn = document.querySelector('.allTasksBtn');
      allTasksBtn.addEventListener('click', function () {
        _this.makeActive(allTasksBtn);
        var pageRenderer = new _render_renderPage__WEBPACK_IMPORTED_MODULE_3__["default"](1, 'all');
      });

      // Today Button
      var todayBtn = document.querySelector('.todayBtn');
      todayBtn.addEventListener('click', function () {
        _this.makeActive(todayBtn);
        var pageRenderer = new _render_renderPage__WEBPACK_IMPORTED_MODULE_3__["default"](1, 'today');
      });

      // Add Project Btn
      var addProjectBtn = document.querySelector('.addProjectBtn');
      addProjectBtn.addEventListener('click', function () {
        _this.makeActive(addProjectBtn);
        ...
        var newProject = _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_1__["default"].createProject();
        var newProjectId = newProject.id;
        console.log("New project created with ID: " + newProjectId);

        // render the page with project ID
        var renderProjectPage = new _render_renderPage__WEBPACK_IMPORTED_MODULE_3__["default"](newProjectId, 'all');
        // render the navbar
        var renderNavbar = new _render_renderNavbar__WEBPACK_IMPORTED_MODULE_4__["default"]();
        renderNavbar.render();
      });

      // check if there are projects and add event listeners to those. 
      var projects = _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_1__["default"].getProjects();
      if (projects) {
        var projectBtns = document.querySelectorAll('.projectBtn');
        projectBtns.forEach(function (projectBtn) {
          var projectId = Number(projectBtn.getAttribute('data-id'));
          projectBtn.addEventListener('click', function () {
            _this.makeActive(projectBtn);
            console.log("ProjectId: " + projectId + 'clicked');
            var renderPage = new _render_renderPage__WEBPACK_IMPORTED_MODULE_3__["default"](projectId, 'all');
            //render navbar
          });
        });
      }
    ...
    key: "makeActive",
    value: function makeActive(button) {
      this.removeActive();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (HandleNavbar);

/***/ }),

/***/ "./src/handle/handlePage.js":
/*!**********************************!*\
  !*** ./src/handle/handlePage.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../manage/ProjectManager */ "./src/manage/ProjectManager.js");
/* harmony import */ var _render_renderPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../render/renderPage */ "./src/render/renderPage.js");
/* harmony import */ var _render_renderAddTaskForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../render/renderAddTaskForm */ "./src/render/renderAddTaskForm.js");
/* harmony import */ var _render_deleteConfirm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../render/deleteConfirm */ "./src/render/deleteConfirm.js");
/* harmony import */ var _render_renderNavbar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../render/renderNavbar */ "./src/render/renderNavbar.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
var HandlePage = /*#__PURE__*/function () {
  function HandlePage(projectId) {
    ...
    this.filter = filter;
    this.project = _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectById(this.projectId);
  ...
  return _createClass(HandlePage, [{
    ...
    value: function handlePage() {
      ...
      if (this.projectId == 1) {
        ...
        // setup project edit handler stuff. 

        var titleInput = document.querySelector('#projectTitle');
        var titleContainer = document.querySelector(".project-title-container"); // add the border effect when textinput is in focus. 

        // Title input
        titleInput.addEventListener('input', function () {
          _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].updateProjectTitle(_this.projectId, titleInput.value);
        });

        // once user clicks out of focus from title input, then the page will re-render. 
        titleInput.addEventListener('blur', function () {
          var renderPage = new _render_renderPage__WEBPACK_IMPORTED_MODULE_1__["default"](_this.projectId, _this.filter);
        ...
        // Description Input
        var descriptionInput = document.querySelector('#projectDescription');
        descriptionInput.addEventListener('input', function () {
          _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].updateProjectDescription(_this.projectId, descriptionInput.value);
        });
        ...
        var deleteProjectButton = document.querySelector('#delete-project-button');
        deleteProjectButton.addEventListener('click', function () {
          (0,_render_deleteConfirm__WEBPACK_IMPORTED_MODULE_3__["default"])('delete-project-button');
        });

        // Add Task Button 
        var addTaskBtn = document.querySelector('.add-project-task');
        addTaskBtn.addEventListener('click', function () {
          (0,_render_renderAddTaskForm__WEBPACK_IMPORTED_MODULE_2__.renderNewAddTaskForm)(_this.projectId);
        });
        this.byTask();
      }
    }
    ...
    value: function byTask() {
      ...
      if (this.tasks) {
        ...
        var completeBtns = document.querySelectorAll('.completed');

        // setup handlers for all of the delete buttons
        deleteBtns.forEach(function (deleteBtn) {
          deleteBtn.addEventListener('click', function () {
            // get taskId from button
            var taskId = Number(deleteBtn.getAttribute('data-id'));
            _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].deleteTaskFromProject(_this2.projectId, taskId);
            // re render page. 
            var renderPage = new _render_renderPage__WEBPACK_IMPORTED_MODULE_1__["default"](_this2.projectId, _this2.filter);
          });
        });
        ...
        editBtns.forEach(function (editBtn) {
          editBtn.addEventListener('click', function () {
            // get taskId from button
            var taskId = Number(editBtn.getAttribute('data-id'));
            // get task from taskId
            var task = _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].getTaskFromProject(_this2.projectId, taskId);
            //console.log(task);
            (0,_render_renderAddTaskForm__WEBPACK_IMPORTED_MODULE_2__.renderEditTaskForm)(_this2.projectId, task);
          });
        });
        ...
        completeBtns.forEach(function (completeBtn) {
          completeBtn.addEventListener('change', function () {
            // get the task id
            var taskId = Number(completeBtn.getAttribute('data-id'));
            // update the task complete property
            if (completeBtn.checked) {
              // if the task is complete it will update to true. 
              _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].updateTaskComplete(_this2.projectId, taskId, true);
            } else {
              _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].updateTaskComplete(_this2.projectId, taskId, false);
            }
            // re-render page
            var renderPage = new _render_renderPage__WEBPACK_IMPORTED_MODULE_1__["default"](_this2.projectId, _this2.filter);
          });
        ...
        taskPanes.forEach(function (taskPane) {
          taskPane.addEventListener('mouseenter', function () {
            ...
            // get edit-pane id
            var editPaneId = "#edit-pane-".concat(id);
            var editPane = document.querySelector(editPaneId);
            editPane.style.visibility = 'visible';
          });
          taskPane.addEventListener('mouseleave', function () {
            var id = taskPane.getAttribute('data-id');
            // get edit-pane id
            var editPaneId = "#edit-pane-".concat(id);
            var editPane = document.querySelector(editPaneId);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (HandlePage);

/***/ }),

/***/ "./src/manage/ProjectManager.js":
/*!**************************************!*\
  !*** ./src/manage/ProjectManager.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _ProjectManager_brand = /*#__PURE__*/new WeakSet();
var ProjectManager = /*#__PURE__*/function () {
  function ProjectManager() {
    ...
    _classPrivateMethodInitSpec(this, _ProjectManager_brand);
    this.projects = [];
    _assertClassBrand(_ProjectManager_brand, this, _loadProjects).call(this);
    this.initializeDefaultProject();
  }
  return _createClass(ProjectManager, [{
    key: "initializeDefaultProject",
    value: function initializeDefaultProject() {
    ...
    value: function createProject() {
      var project = new _objects_Project__WEBPACK_IMPORTED_MODULE_0__["default"](_assertClassBrand(_ProjectManager_brand, this, _generateProjectId).call(this), "New Project", "");
      this.projects.push(project);
      _assertClassBrand(_ProjectManager_brand, this, _saveProjects).call(this);
      return project;
    }
  }, {
    key: "getProjectById",
    ...
    value: function getTaskFromProject(projectId, taskId) {
      ...
      if (project) {
        ...
        if (task) {
          ...
          console.log("Task with ID ".concat(taskId, " not found in project with ID ").concat(projectId));
          return null;
        }
      } else {
        console.log("Project with ID ".concat(projectId, " not found."));
        return null;
      }
    }
    // returns either a task array from the project or an empty task array if no tasks were yet assigned to this project. 
  }, {
    key: "getTasksFromProject",
    value: function getTasksFromProject(projectId) {
    ...
    key: "updateProjectTitle",
    value: function updateProjectTitle(projectId, newTitle) {
      var project = this.getProjectById(projectId);
      if (project) {
    ...
    value: function updateProjectDescription(projectId, newDescription) {
      var project = this.getProjectById(projectId);
      if (project) {
    ...
    value: function updateProjectTask(projectId, taskId, updatedTask) {
      var project = this.getProjectById(projectId);
      if (project) {
        project.updateTask(taskId, updatedTask);
        _assertClassBrand(_ProjectManager_brand, this, _sortTasksByDate).call(this, projectId); // Ensure tasks are sorted after updating
        _assertClassBrand(_ProjectManager_brand, this, _saveProjects).call(this);
      }
    }
    ...
    */
    ...
    value: function updateTaskComplete(projectId, taskId, complete) {
      var project = this.getProjectById(projectId);
      if (project) {
        ...
        if (task) {
          ...
          _assertClassBrand(_ProjectManager_brand, this, _saveProjects).call(this); // Persist the change
        } else {
          console.error("Task with ID ".concat(taskId, " not found in project with ID ").concat(projectId));
        }
      } else {
        console.error("Project with ID ".concat(projectId, " not found."));
      }
    }
  }, {
    key: "addTaskToProject",
    value: function addTaskToProject(projectId, task) {
      var project = this.getProjectById(projectId);
      if (project) {
        project.addTask(task);
        _assertClassBrand(_ProjectManager_brand, this, _sortTasksByDate).call(this, projectId); // Sort tasks immediately after adding a new one
        _assertClassBrand(_ProjectManager_brand, this, _saveProjects).call(this);
      }
    }
  }, {
    key: "deleteTaskFromProject",
    value: function deleteTaskFromProject(projectId, taskId) {
      var project = this.getProjectById(projectId);
      if (project) {
        project.removeTask(taskId);
        _assertClassBrand(_ProjectManager_brand, this, _sortTasksByDate).call(this, projectId); // Sort tasks immediately after removing one
        _assertClassBrand(_ProjectManager_brand, this, _saveProjects).call(this);
      }
...
function _sortTasksByDate(projectId) {
  var project = this.getProjectById(projectId);
  if (project) {
...
function _saveProjects() {
  localStorage.setItem('projects', JSON.stringify(this.projects.map(function (project) {
    return project.toJSON();
  })));
}
function _loadProjects() {
  var projectsData = JSON.parse(localStorage.getItem('projects') || '[]');
  this.projects = projectsData.map(_objects_Project__WEBPACK_IMPORTED_MODULE_0__["default"].fromJSON);
}
function _generateProjectId() {
  return this.projects.reduce(function (maxId, project) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Task__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Task */ "./src/objects/Task.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
 ...
 */
var _Project_brand = /*#__PURE__*/new WeakSet();
var Project = /*#__PURE__*/function () {
  function Project(id, title, description) {
    _classCallCheck(this, Project);
    _classPrivateMethodInitSpec(this, _Project_brand);
    this.id = id;
    this.title = title;
  ...
  return _createClass(Project, [{
    key: "addTask",
    value: function addTask(taskData) {
      var task = _Task__WEBPACK_IMPORTED_MODULE_0__["default"].fromJSON(_objectSpread(_objectSpread({}, taskData), {}, {
        id: _assertClassBrand(_Project_brand, this, _generateTaskId).call(this)
      }));
    ...
    key: "updateTask",
    value: function updateTask(taskId, updatedTaskData) {
    ...
    value: function fromJSON(data) {
      var project = new Project(Number(data.id), data.title, data.description);
      project.tasks = data.tasks.map(_Task__WEBPACK_IMPORTED_MODULE_0__["default"].fromJSON);
      return project;
    }
  }]);
}();
function _generateTaskId() {
  return this.tasks.length > 0 ? Math.max.apply(Math, _toConsumableArray(this.tasks.map(function (task) {
    return task.id;
  }))) + 1 : 1;
}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/formatISO.mjs");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
var Task = /*#__PURE__*/function () {
  function Task(id, title, description, date, priority, complete) {
  ...
  return _createClass(Task, [{
    ...
    value: function toJSON() {
      return {
        ...
        title: this.title,
        description: this.description,
        date: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.formatISO)(this.date),
    ...
    key: "fromJSON",
    value: function fromJSON(data) {
      return new Task(Number(data.id), data.title, data.description, new Date(data.date),
      // parse ISO string date
      data.priority, data.complete);
    }
  }]);
}();
...
/* harmony export */ });
/* harmony import */ var _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../manage/ProjectManager */ "./src/manage/ProjectManager.js");
/* harmony import */ var _renderNavbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./renderNavbar */ "./src/render/renderNavbar.js");
/* harmony import */ var _renderPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./renderPage */ "./src/render/renderPage.js");
...
function deleteConfirm(elementId) {
  ...
  var projectId = Number(element.getAttribute('data-id'));
  handleDeleteConfirm(projectId);
}
function createDeleteConfirm(top, left) {
  var deleteConfirm = document.createElement('dialog');
  ...
  deleteConfirm.style.top = "".concat(top, "px");
  deleteConfirm.style.left = "".concat(left, "px");
  return deleteConfirm;
}
function handleDeleteConfirm(projectId) {
  var yes = document.getElementById('deleteYes');
  var no = document.getElementById('deleteNo');
  yes.addEventListener('click', function () {
    // delete project
    _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_0__["default"].deleteProject(projectId);
    //close dialog box
    closeDialog();
    var renderPage = new _renderPage__WEBPACK_IMPORTED_MODULE_2__["default"](1);
    renderPage.renderPage();
    var renderNavbar = new _renderNavbar__WEBPACK_IMPORTED_MODULE_1__["default"]();
    renderNavbar.render();
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (deleteConfirm);

/***/ }),

/***/ "./src/render/renderAddTaskForm.js":
/*!*****************************************!*\
  !*** ./src/render/renderAddTaskForm.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   renderNewAddTaskForm: () => (/* binding */ renderNewAddTaskForm)
/* harmony export */ });
/* harmony import */ var _create_createAddTaskForm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../create/createAddTaskForm */ "./src/create/createAddTaskForm.js");
/* harmony import */ var _handle_handleAddTaskForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../handle/handleAddTaskForm */ "./src/handle/handleAddTaskForm.js");
...
function renderEditTaskForm(projectId, task) {
  body.appendChild((0,_create_createAddTaskForm__WEBPACK_IMPORTED_MODULE_0__["default"])(task));
  var taskId = task.id;
  (0,_handle_handleAddTaskForm__WEBPACK_IMPORTED_MODULE_1__["default"])(projectId, taskId);
}
function renderNewAddTaskForm(projectId) {
  body.appendChild((0,_create_createAddTaskForm__WEBPACK_IMPORTED_MODULE_0__["default"])());
  (0,_handle_handleAddTaskForm__WEBPACK_IMPORTED_MODULE_1__["default"])(projectId);
}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _create_createNavbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../create/createNavbar */ "./src/create/createNavbar.js");
/* harmony import */ var _handle_handleNavbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../handle/handleNavbar */ "./src/handle/handleNavbar.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
 ...
 * Renders the navbar
 */
var RenderNavbar = /*#__PURE__*/function () {
  function RenderNavbar() {
    _classCallCheck(this, RenderNavbar);
    this.sidebar = document.querySelector(".sidebar");
    this.createNavbar = new _create_createNavbar__WEBPACK_IMPORTED_MODULE_0__["default"]('Joel');
  }
  return _createClass(RenderNavbar, [{
    key: "render",
    value: function render() {
      //clear and reprint navbar. 
      this.sidebar.innerHTML = "";
      var navbarContainer = this.createNavbar.getNavbar();
      this.sidebar.appendChild(navbarContainer);
      // activate handling
      var handleNavbar = new _handle_handleNavbar__WEBPACK_IMPORTED_MODULE_1__["default"]();
    }
  }]);
}();
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _create_createTasks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../create/createTasks */ "./src/create/createTasks.js");
/* harmony import */ var _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../manage/ProjectManager */ "./src/manage/ProjectManager.js");
/* harmony import */ var _handle_handlePage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../handle/handlePage */ "./src/handle/handlePage.js");
...
var RenderPage = /*#__PURE__*/function () {
  ...
  return _createClass(RenderPage, [{
    key: "init",
    value: function init() {
      // get the project
      this.project = _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectById(this.projectId);
      // check if project exsists. 
      if (!this.project) {
        console.error('Project not found!');
      } else {
        this.tasks = this.project.tasks;
        this.completeTasks = this.tasks.filter(function (task) {
    ...
    value: function renderPage() {
      ...
      if (this.projectId == 1) {
        if (this.filter == 'all') {
          ...
          //setup page handlers
          var handlePage = new _handle_handlePage__WEBPACK_IMPORTED_MODULE_2__["default"](1, this.filter);
          handlePage.byTask();
        } else if (this.filter == 'today') {
          this.main.appendChild(this.renderToday());
          //setup page handlers
          var _handlePage = new _handle_handlePage__WEBPACK_IMPORTED_MODULE_2__["default"](1, this.filter);
          _handlePage.byTask();
        } else {
        ...
        // setup page Handlers. 
        var _handlePage2 = new _handle_handlePage__WEBPACK_IMPORTED_MODULE_2__["default"](this.projectId, this.filter);
        _handlePage2.handlePage();
      }
    }
  }, {
    key: "renderToday",
    value: function renderToday() {
      ...
      var todayTasks = this.filterTasksByToday(this.incompleteTasks);
      var completeTodayTasks = this.filterTasksByToday(this.completeTasks);
      var taskElement = (0,_create_createTasks__WEBPACK_IMPORTED_MODULE_0__["default"])(todayTasks);
      var completeTasksElement = this.createCompleteElement(completeTodayTasks);
      // create header
      var taskHeader = this.createTaskHeader("Today");
    ...
    key: "renderAllTasks",
    value: function renderAllTasks() {
      var mainTaskContainer = document.createElement('div');
      mainTaskContainer.classList.add('main-task-container');
      var taskHeader = this.createTaskHeader("All Tasks");
      var taskElement = (0,_create_createTasks__WEBPACK_IMPORTED_MODULE_0__["default"])(this.incompleteTasks);
      var completeTasksElement = this.createCompleteElement(this.completeTasks);
      mainTaskContainer.appendChild(taskHeader);
      mainTaskContainer.appendChild(taskElement);
      mainTaskContainer.appendChild(completeTasksElement);
      return mainTaskContainer;
    ...
    key: "renderProjectPage",
    value: function renderProjectPage() {
      ...
      projectForm.innerHTML = "\n            <div class=\"project-info-container\">\n                <div class=\"project-title-container\">\n                    <input type=\"text\" id=\"projectTitle\" value=\"".concat(this.project.title, "\">\n                    <button id = \"delete-project-button\" data-id =\"").concat(this.project.id, "\"><span class=\"material-symbols-outlined\">\n                    delete\n                    </span></button>\n                </div>\n                <textarea name=\"projectDescription\" id=\"projectDescription\" cols=\"30\" rows=\"3\" placeholder=\"Description...\">").concat(this.project.description, "</textarea> \n            </div>\n        ");
      ...
      var mainTaskContainer = document.createElement('div');
      mainTaskContainer.classList.add('main-task-container');
      var addTaskProjectBtn = document.createElement('button');
      addTaskProjectBtn.classList.add('add-project-task');
      addTaskProjectBtn.setAttribute('data-id', "".concat(this.project.id));
    ...
    key: "createCompleteElement",
    value: function createCompleteElement(completeTasks) {
      var completeTasksElement = document.createElement('div');
      completeTasksElement.classList.add('complete-tasks');
      if (completeTasks.length > 0) {
        // if there are complete tasks
        //create header
        var completeTasksHeader = this.createTaskHeader('Complete');
        var _completeTasks = (0,_create_createTasks__WEBPACK_IMPORTED_MODULE_0__["default"])(this.completeTasks);
        // create complete task list. 
        completeTasksElement.appendChild(completeTasksHeader);
        completeTasksElement.appendChild(_completeTasks);
      }
      return completeTasksElement;
    }
  }, {
    key: "filterTasksByToday",
    value: function filterTasksByToday(tasks) {
      return tasks.filter(function (task) {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.isToday)(new Date(task.date));
      });
    }
  }, {
    key: "createTaskHeader",
    value: function createTaskHeader(headerName) {
      var taskHeader = document.createElement('div');
      taskHeader.classList.add('task-header');
      taskHeader.innerHTML = "<h2>".concat(headerName, "</h2><div class=\"main-line\"></div>");
      return taskHeader;
    }
  }]);
}();
...
var RenderTasks = /*#__PURE__*/function () {
  function RenderTasks(project) {
    _classCallCheck(this, RenderTasks);
    this.project = project;
    this.tasks = project.tasks;
    this.main = document.querySelector('main');
  }
  return _createClass(RenderTasks, [{
    key: "renderAllTasks",
    value: function renderAllTasks() {
...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Jersey+10&family=Reddit+Mono:wght@200..900&display=swap);"]);
...
/* harmony import */ var _manage_ProjectManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./manage/ProjectManager */ "./src/manage/ProjectManager.js");
/* harmony import */ var _render_renderNavbar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./render/renderNavbar */ "./src/render/renderNavbar.js");
/* harmony import */ var _render_renderPage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./render/renderPage */ "./src/render/renderPage.js");
...
// print navbar. 
var renderNavbar = new _render_renderNavbar__WEBPACK_IMPORTED_MODULE_2__["default"]();
renderNavbar.render();

// REnder all tasks page by default 
var renderPage = new _render_renderPage__WEBPACK_IMPORTED_MODULE_3__["default"]();
})();
